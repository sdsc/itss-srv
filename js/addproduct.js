...
function addProduct(id)
{
    ...
    /* BEGIN SYSTEM MANAGEMENT */
        ...
        addItemLine(table, "Non-recommended hardware", PRICE_SYSTEM_MANAGEMENT_UC[1], id_prefix, vm_num, item_num++, "To receive this option, enter 1", "pa-sub", id, 0, 0, 0);
