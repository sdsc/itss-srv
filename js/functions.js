...
function addProduct(id)
{
	...
	cell.id = vm_type_price + (++item_num); //first item
	 ...
	 cell.id = vm_type_price + (++item_num);
        ...
        mem_qty.setAttribute("num", item_num);
	    ...
	    cell.id = vm_type_price + (++item_num);
            ...
            str_qty.setAttribute("num", item_num);
            ...
            str_units.id = "str-units" + item_num;
	...
	cell.id = vm_type_price + (++item_num);
        ...
        san_qty.setAttribute("num", item_num);
        ...
        san_units.id = "san-units" + item_num;
	...
	cell.id = vm_type_price + (++item_num);        
        ...
        extrasnap.id = vm_type_price + item_num;
        extrasnap.setAttribute("value", "No");
        extrasnap.setAttribute("num", service_num);
        ...
        extrasnap.setAttribute("name", item.id);
        extrasnap.setAttribute("title", "Marking yes will add $" + price_vm[5] + " to the subtotal");
        extrasnap.setAttribute("onchange", "extraSnaps(this.getAttribute('num'))");
        ...
        if (id == 'HS_VM') {
            ...
            sysmanagement_text.id = "sys" + item_num;
